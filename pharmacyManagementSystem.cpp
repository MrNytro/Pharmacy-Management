...
void pharmacyManagementSystem::search()
{
    ...
    cout << "Search :\n";
    cout << "=====================================================" << endl;
    cout << "Enter The Name Of The Medicine You Wish To Search : ";
    cin.ignore();
    getline(cin, search);
    cout << endl;
    for (i = 0; i < MAX; i++)
...
void pharmacyManagementSystem::userSelection()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            if (!(strcmp((userName.c_str()), ("Vishal"))) && (passWord == "123") || !(strcmp((userName.c_str()), ("Utkarsh"))) && !(strcmp((passWord.c_str()), ("123"))))
            {
                cout << "\n******************Access Granted******************\n"
                     << endl;
...
int main(void)
{
    ...
    Type("||\tBy : \t\t\t\t\t||\n");
    Type("||\tVishal Bajpai 1RF30IS063 \t\t||\n");
    Type("||\tUtkarsh Raikwal 1RF20IS050 \t\t||\n");
    Type("--------------------------------------------------\n");
    Sleep(100);
    system("CLS");
    pharmacyManagementSystemObj.userSelection();
    return 0;
}